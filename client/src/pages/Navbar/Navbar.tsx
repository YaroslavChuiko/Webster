import { Box, Flex, Spacer, Button, Menu, MenuButton, MenuList, MenuItem, Text, useColorModeValue, ChakraProvider, Divider } from '@chakra-ui/react';
...
function Navbar() {
    ...
    return (
        <ChakraProvider theme={customTheme}>
            <Flex bgGradient="linear(to-r, teal.300, blue.300, blue.400, blue.500, blue.500, purple.600, purple.600, purple.600)" pt="2" pb="2" align="center">
                <Box>
